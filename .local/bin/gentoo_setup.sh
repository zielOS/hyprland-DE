*** BTRFS
 cfdisk /dev/nvme0n1 && mkfs.vfat -F 32 /dev/nvme0n1p1 && cryptsetup -c aes-xts-plain64 -s 512 -y luksFormat /dev/nvme0n1p2 && cryptsetup luksOpen /dev/nvme0n1p2 cryptroot && mkfs.btrfs /dev/mapper/cryptroot && mkdir /mnt/arch && mount /dev/mapper/cryptroot /mnt/arch && btrfs subvolume create /mnt/arch/@ && btrfs subvolume create /mnt/arch/@/.snapshots && mkdir /mnt/arch/@/.snapshots/1 && btrfs subvolume create /mnt/arch/@/.snapshots/1/snapshot && mkdir -p /mnt/arch/@/boot/grub2/ && btrfs subvolume create /mnt/arch/@/boot/grub2/i386-pc && btrfs subvolume create /mnt/arch/@/boot/grub2/x86_64-efi && btrfs subvolume create /mnt/arch/@/home && btrfs subvolume create /mnt/arch/@/opt && btrfs subvolume create /mnt/arch/@/root && btrfs subvolume create /mnt/arch/@/srv && btrfs subvolume create /mnt/arch/@/tmp && mkdir /mnt/arch/@/usr/ && btrfs subvolume create /mnt/arch/@/usr/local && btrfs subvolume create /mnt/arch/@/var && btrfs subvolume create /mnt/arch/@/var/log && btrfs subvolume create /mnt/arch/@/var/log/audit && chattr +c /mnt/arch/@/var && nvim /mnt/arch/@/.snapshots/1/info.xml
